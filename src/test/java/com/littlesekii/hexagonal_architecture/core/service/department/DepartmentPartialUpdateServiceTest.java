...
public class DepartmentPartialUpdateServiceTest {
    
    @Mock
    private DepartmentRepositoryPort repositoryPort;

    private DepartmentPartialUpdateService service;

    @BeforeEach
    void setUp() {
        service = new DepartmentPartialUpdateService(repositoryPort);
    }

    @Test
    void partialUpdate_withName_updatesNameAndReturnDepartment() {
    ...
    @Test
    void partialUpdate_withNullName_worksAndReturnDepartment() {
        Department existingDepartment = new Department(1L, "Engineering");
    ...
    @Test
    void partialUpdate_withSameName_updatesAndReturnDepartment() {
        Department existingDepartment = new Department(1L, "Engineering");
    ...
    @Test
    void partialUpdate_withDuplicateName_throwsException() {
        Department existingDepartment = new Department(1L, "Engineering");
        Department updateData = new Department(null, "Marketing");
    ...
    @Test
    void partialUpdate_withNonExistentDepartment_throwsException() {
        Department updateData = new Department(null, "Marketing");
